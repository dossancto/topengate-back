        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    owner_phone_number = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    document = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    document_type = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_organization_invites_org_email_is_deleted",
                table: "organization_invites",
                columns: new[] { "organization_id", "email", "is_deleted" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_organizations_slug_deleted_at",
                table: "organizations",
